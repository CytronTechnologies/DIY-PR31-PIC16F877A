...
//				 		 FM radio. User are introduce to communicate with the chip using
//						 I2C. This programme include source code for I2C interfacing,  
//						 LCD display, monitor display througt uart,R/W EEPROM and monitor
//						 push button's input to execute selected loop. 
//					 
//=============================================================================================
